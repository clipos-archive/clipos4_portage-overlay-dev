...
src_prepare() {
	...
	# copy .h files for tools compilation
	cp ${S}/include/uapi/linux/errno.h ${S}/tools/include/linux
	cp ${S}/include/uapi/asm-generic/errno.h ${S}/tools/include/asm
	mkdir ${S}/tools/include/asm-generic
	cp ${S}/include/uapi/asm-generic/errno-base.h ${S}/tools/include/asm-generic
}
