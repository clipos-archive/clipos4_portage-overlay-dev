...
# for clip : replaced 6 by 5
EAPI=5

# replaced for clip PYTHON_COMPAT
...
# clip : added src_prepare impl as in eapi 6 PATCHES are implicitly applied
# when src_prepare is not declared.
src_prepare() {
	epatch ${PATCHES}
}
